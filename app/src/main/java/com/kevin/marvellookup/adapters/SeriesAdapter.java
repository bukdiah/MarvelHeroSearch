...
import com.kevin.marvellookup.SeriesInfo;
...
public class SeriesAdapter extends RecyclerView.Adapter<SeriesAdapter.MyViewHolder>{
    List<SeriesInfo> data = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;

    public SeriesAdapter(Context context, List<SeriesInfo> data) {
        this.data = data;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SeriesInfo current = data.get(position);
